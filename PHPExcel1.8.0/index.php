...
function exportExcelDownload($filename, $fileversion) {
    ...
    //设置默认字体及大小
    $objPHPExcel->getDefaultStyle()->getFont()->setName('Courier New')->setSize(10);
    ...
    $objPHPExcel->setActiveSheetIndex(0)->setCellValue('A4', 12); //数据类型：Number-Integer
